                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            _buildProfileStat("Followers", "984"),
                            _buildProfileStat("Following", "243"),
                          ],
                        ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: CircleAvatar(
              radius: 12,
              backgroundImage: CachedNetworkImageProvider('https://fastly.picsum.photos/id/11/3888/2592.jpg?hmac=dkM-BSWi2m7YAH3n-fvvXSzUS4k668DYPBZ6UVoJN10'),
            ),
            label: '',
          ),
        ],
